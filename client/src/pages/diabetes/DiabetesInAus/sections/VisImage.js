  ...
  return (
    <MKBox>
      ...
      <Typography variant="body1">
        (Odd ratio = 1: means healthy in this factor; Odd ratio = 2 : twice the risk as healthy people)
        The graph shows that the older you are, the more likely you are to develop diabetes.
      </Typography>
    </MKBox>
  );
